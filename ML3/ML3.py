...
X_temp, X_test, y_temp, y_test = train_test_split(
    X, y, test_size=20000, random_state=123, stratify=y)
...
class NeuralNetMLP2HLayers:
    ...
    def backward(self, x, a_h1, a_h2, a_out, y):
        ...
        # output dim: [num_hidden2, num_hidden1]
        d_z_out__a_h1 = self.weight_h2

        # output dim: [n_examples, n_classes]* [num_hidden2, num_hidden1] = [n_examples, num_hidden1]

        d_loss__a_h1 = np.dot(d_loss__a_h2, d_z_out__a_h1)
...
model = NeuralNetMLP2HLayers(num_features=28 * 28,
                             num_hidden1=200,
                             num_hidden2=200,
                             num_classes=10)
...
def train(model, X_train, y_train, X_valid, y_valid, num_epochs,
    ...
    for e in range(num_epochs):
        ...
        for X_train_mini, y_train_mini in minibatch_gen:
            ...
            d_loss__d_w_out, d_loss__d_b_out, d_loss__d_w_h2, d_loss__d_b_h2, d_loss__d_w_h1, d_loss__d_b_h1 = model.backward(X_train_mini, a_h1, a_h2, a_out,
                                                                                            y_train_mini)
